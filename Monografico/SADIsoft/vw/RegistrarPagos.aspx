        ...
        <fieldset>
            ...
            <div id="gri">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="555px" Height="208px" OnRowDataBound="GridView1_RowDataBound" ShowFooter="True" DataKeyNames="FacturaId" DataSourceID="SadiConnectionString" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" EnableViewState="False" CellSpacing="2" ForeColor="Black">
                            <Columns>
                                ...
                                <asp:BoundField DataField="Mora" HeaderText="Mora" ReadOnly="True" SortExpression="Mora" DataFormatString="{0:N2}" />
                                <asp:BoundField DataField="TotalCuota" HeaderText="Total de Cuota" SortExpression="TotalCuota" DataFormatString="{0:N2}" />
                                <asp:BoundField DataField="FechaGenerada" HeaderText="Fecha Generada" SortExpression="FechaGenerada" DataFormatString="{0:d}" />
