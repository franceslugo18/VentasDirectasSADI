        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="viewer">
                    <br />
                    &nbsp;&nbsp;&nbsp;
                     <asp:Label ID="Label1" class="col-md-4 control-label" runat="server" Text="Seleccione Reporte:"></asp:Label>
                    &nbsp;&nbsp;
                    ...
                    &nbsp;
                     <div id="rep">
                         <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1001px">
                         </rsweb:ReportViewer>
